 ...
 *  invoking after the `FMDBService initialize` in YourModelClass.m `getUsingFMDBService` function
 */
 ...
 */
- (void)executeForTransaction:(BOOL (^)(FMDBService *helper))block;

@end

@interface FMDBService (DatabaseManager)
...
@interface FMDBService (DatabaseExecute)
/**
 ...
 */
- (nullable NSMutableArray *)searchWithParams:(FMDBSQueryParams *)params;
 ...
 *  example: 
            NSMutableArray *array = [[FMDBService getUsingFMDBService] searchWithSQL:@"select * from @t where blah blah.." toClass:[ModelClass class]];
 *
 */
 ...
 *  example:
 NSMutableArray *array = [[FMDBService getUsingFMDBService] searc:[ModelClass class] withSQL:@"select rowid from name_table where name = ?", @"Swift"];
 *
 */
...
@interface FMDBService (Deprecated_Nonfunctional)
/// you can use [FMDBService getUsingFMDBService]
#pragma mark - deprecated
+ (FMDBService *)sharedDBHelper __deprecated_msg("Method deprecated. Use `[Model getUsingFMDBService]`");
...
- (void)setEncryptionKey:(NSString *)encryptionKey __deprecated_msg("Method deprecated. Use `setKey: OR resetKey:` invoking after the `FMDBService initialize` in YourModelClass.m `getUsingFMDBService` function");
#pragma mark -
@end
